...
// The one read in the extension that isn't a file, so it doesn't come through `config/read.ts` and
// has to say so itself — otherwise a slow launch on a machine full of Copilot sessions has a gap
// where its biggest read should be.
