import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{at as t,g as n,it as r,ln as i,n as a,r as o}from"./iframe-ByZCPzNU.js";import{n as s,t as c}from"./SettingsContext-Bmk1GVxM.js";import{S as l,c as u,f as d,h as f,i as p,l as m,m as h,n as g,o as _,p as v,r as y,s as b,u as x,v as S,x as C}from"./agent-fixtures-4ClEYCc9.js";import{n as w,t as T}from"./AgentRow-CjvyJYq8.js";import{d as E,o as D}from"./session-detail-fixtures-i6NA3UbE.js";var O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K;function q(){return(q=e((()=>{t(),w(),s(),v(),n(),D(),O=a(),k=i(),A={title:`Agents/AgentRow`,component:T,args:{now:Date.now(),workspaceRoot:o,onOpen:()=>void 0,onAnalyze:()=>void 0,onOpenLog:()=>void 0,onCopySessionId:()=>void 0,onKill:()=>void 0},decorators:[e=>(0,O.jsx)(c,{settings:{...r,stages:{names:E}},children:(0,O.jsx)(e,{})}),e=>(0,O.jsx)(`div`,{className:`w-full max-w-2xl p-2`,children:(0,O.jsx)(e,{})})]},j={args:{agent:l}},M={args:{agent:C}},N={args:{agent:d}},P={args:{agent:h}},F={args:{agent:f}},I={args:{agent:S}},L={args:{agent:x}},R={args:{agent:d}},z={args:{agent:m}},B={args:{agent:_}},V={args:{agent:b}},H={args:{agent:u}},U={args:{agent:p}},W={args:{agent:y}},G={render:e=>(0,O.jsx)(`div`,{className:`flex flex-col gap-1`,children:[l,C,g,m,p].map(t=>(0,k.createElement)(T,{...e,key:t.sessionId,agent:t}))})},j.parameters={...j.parameters,docs:{...j.parameters?.docs,source:{originalSource:`{
  args: {
    agent: workingAgent
  }
