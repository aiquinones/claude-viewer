import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{K as t,Q as n,Y as r,Z as i,n as a}from"./iframe-jcHePZlb.js";import{n as o,t as s}from"./MemoryIndexCard-Cafkx0nZ.js";var c,l,u,d,f,p,m,h;function g(){return(g=e((()=>{o(),r(),c=a(),l={title:`Memory/MemoryIndexCard`,component:s,args:{selected:!1,onSelect:()=>void 0,onOpenFile:()=>void 0},decorators:[e=>(0,c.jsx)(`div`,{className:`w-[620px] p-3`,children:(0,c.jsx)(e,{})})]},u={args:{index:i}},d={args:{index:i,selected:!0}},f={args:{index:n}},p={args:{index:{...t,issues:[{severity:`warning`,message:`no MEMORY.md — nothing points at these files, so no session will read them`}]}}},m={args:{index:t}},u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`{
  args: {
    index: memoryIndex
  }
