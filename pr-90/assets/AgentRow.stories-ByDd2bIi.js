import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{g as t,ln as n,n as r,r as i}from"./iframe-Ct3ufPd1.js";import{a,b as o,c as s,d as c,f as l,g as u,i as d,n as f,o as p,p as m,s as h,u as g,y as _}from"./agent-fixtures-jdx0kAWl.js";import{n as v,t as y}from"./AgentRow-DglmPGF-.js";var b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I;function L(){return(L=e((()=>{v(),c(),t(),b=r(),x=n(),S={title:`Agents/AgentRow`,component:y,args:{now:Date.now(),workspaceRoot:i,onOpen:()=>void 0,onAnalyze:()=>void 0,onOpenLog:()=>void 0,onCopySessionId:()=>void 0,onKill:()=>void 0},decorators:[e=>(0,b.jsx)(`div`,{className:`w-full max-w-2xl p-2`,children:(0,b.jsx)(e,{})})]},C={args:{agent:o}},w={args:{agent:_}},T={args:{agent:g}},E={args:{agent:l}},D={args:{agent:m}},O={args:{agent:u}},k={args:{agent:s}},A={args:{agent:g}},j={args:{agent:h}},M={args:{agent:d}},N={args:{agent:a}},P={args:{agent:p}},F={render:e=>(0,b.jsx)(`div`,{className:`flex flex-col gap-1`,children:[o,_,f,h].map(t=>(0,x.createElement)(y,{...e,key:t.sessionId,agent:t}))})},C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`{
  args: {
    agent: workingAgent
  }
