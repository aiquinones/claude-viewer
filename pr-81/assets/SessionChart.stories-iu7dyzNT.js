import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{Ct as t,Ht as n,Nt as r,St as i,Wt as a,at as o,it as s,jt as c,n as l}from"./iframe-nKyh0Q_w.js";import{n as u,t as d}from"./context-u3L7GrvR.js";import{a as f,c as p,i as m,l as h,n as g,o as _,r as v,s as y,t as b,u as x}from"./SessionChart-9GerwVAy.js";import{i as S,n as C,o as w}from"./session-detail-fixtures-DLAk1DJ5.js";var T,E,D,O,k,A,j,M,N,P,F,I;function L(){return(L=e((()=>{d(),o(),x(),v(),g(),r(),i(),a(),w(),T=l(),E=y({turns:C.turns,metric:`output-tokens`,costBasis:`all`}),D=_({points:E,invocations:C.invocations}),O={title:`Usage/SessionChart`,component:b,args:{points:E,loads:D,max:m(E),unit:`output tokens`,format:n,empty:`No requests recorded for this session.`},decorators:[e=>(0,T.jsx)(`div`,{className:`w-[42rem] max-w-full p-4`,style:{"--surface-accent":t(`usage`)},children:(0,T.jsx)(e,{})})]},k={},A={args:(()=>{let e=E.slice(0,8);return{points:e,loads:_({points:e,invocations:C.invocations}),max:m(e)}})()},j={args:{points:E.slice(0,1),loads:[],max:m(E.slice(0,1))}},M={args:(()=>{let e=f(C.contexts),t=u({context:C.contexts[C.contexts.length-1],settings:{...s.context,warnAt:{value:6e4,source:`user`}}}),n=h({reading:t,peak:m(e)});return{points:e,loads:_({points:e,invocations:C.invocations}),guides:p({reading:t,max:n}),max:n,unit:`context`,format:c}})()},N={args:(()=>{let e=y({turns:S.turns,metric:`output-tokens`,costBasis:`all`});return{points:e,loads:_({points:e,invocations:S.invocations}),max:m(e)}})()},P={args:{points:[],loads:[],max:0}},F={args:(()=>{let e=E.reduce((e,t,n)=>t.value>E[e].value?n:e,0);return{loads:_({points:E,invocations:[`dev-feature`,`create-pr`,`claude-api`,`design`,`post-mortem`,`publish`].map(t=>({skill:t,at:E[e].at,via:`command`}))})}})()},k.parameters={...k.parameters,docs:{...k.parameters?.docs,source:{originalSource:`{}`,...k.parameters?.docs?.source}}},A.parameters={...A.parameters,docs:{...A.parameters?.docs,source:{originalSource:`{
  args: (() => {
