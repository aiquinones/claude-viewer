import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{n as t}from"./iframe-DgMGEB4r.js";import{f as n,h as r,u as i,v as a}from"./agent-fixtures-CpK73hNA.js";import{n as o,t as s}from"./AgentFlags-wcLrqVjk.js";var c,l,u,d,f,p,m,h;function g(){return(g=e((()=>{o(),i(),c=t(),l={title:`Agents/AgentFlags`,component:s,decorators:[e=>(0,c.jsx)(`div`,{className:`flex justify-start p-6 pb-40`,children:(0,c.jsx)(e,{})})]},u={args:{agent:a}},d={args:{agent:n}},f={args:{agent:r}},p={args:{agent:{...r,issues:[{severity:`warning`,message:`no transcript on disk yet — nothing has been written for this session`}]}}},m={args:{agent:{...a,issues:[{severity:`error`,message:`could not read the event log: EACCES permission denied`}]}}},u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`{
  args: {
    agent: workingAgent
  }
