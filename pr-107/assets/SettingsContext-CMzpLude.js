import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{at as t,dn as n,ht as r,it as i,mt as a,n as o}from"./iframe-DYWEEjxs.js";var s,c,l,u,d,f,p,m,h,g,_,v;function y(){return(y=e((()=>{s=n(),r(),t(),c=o(),l=(0,s.createContext)({settings:i,openSettings:()=>void 0,setUsage:()=>void 0,openEstimator:()=>void 0,setEstimator:()=>void 0,setTheme:()=>void 0,setStageNames:()=>void 0}),u=({settings:e=i,openSettings:t=()=>void 0,setUsage:n=()=>void 0,openEstimator:r=()=>void 0,setEstimator:a=()=>void 0,setTheme:o=()=>void 0,setStageNames:s=()=>void 0,children:u})=>(0,c.jsx)(l.Provider,{value:{settings:e,openSettings:t,setUsage:n,openEstimator:r,setEstimator:a,setTheme:o,setStageNames:s},children:u}),d=()=>(0,s.useContext)(l).settings,f=()=>(0,s.useContext)(l).openSettings,p=()=>(0,s.useContext)(l).setUsage,m=()=>(0,s.useContext)(l).openEstimator,h=()=>(0,s.useContext)(l).setTheme,g=()=>(0,s.useContext)(l).setStageNames,_=()=>(0,s.useContext)(l).settings.tokens.estimator.value,v=()=>{let e=_();return(0,s.useCallback)(t=>a({chars:t,estimator:e}),[e])},u.__docgenInfo={description:``,methods:[],displayName:`SettingsProvider`,props:{children:{required:!0,tsType:{name:`ReactNode`},description:``},settings:{defaultValue:{value:`{
  tokens: {
