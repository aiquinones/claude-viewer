import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{_t as t,g as n,n as r,r as i}from"./iframe-CxMiWaiR.js";import{c as a,d as o,f as s,h as c,i as l,l as u,m as d,n as f,u as p}from"./agent-fixtures-C1uQMexk.js";import{n as m,t as h}from"./AgentRobotRow-DRsnv3Ms.js";var g,_,v,y,b,x,S,C,w,T,E,D,O;function k(){return(k=e((()=>{p(),m(),n(),g=r(),_=t(),v={title:`Agents/AgentRobotRow`,component:h,args:{workspaceRoot:i,onOpen:()=>void 0,onOpenLog:()=>void 0},decorators:[e=>(0,g.jsx)(`div`,{className:`p-3`,children:(0,g.jsx)(e,{})})],render:e=>(0,g.jsx)(h,{...e,now:Date.now()})},y={args:{agent:c}},b={args:{agent:d}},x={args:{agent:f}},S={args:{agent:u}},C={args:{agent:l}},w={args:{agent:o}},T={args:{agent:s}},E={render:e=>(0,g.jsxs)(`div`,{className:`flex flex-col gap-1`,children:[(0,g.jsx)(h,{...e,agent:d,now:Date.now()}),(0,g.jsx)(h,{...e,agent:c,now:Date.now()})]})},D={render:e=>(0,g.jsx)(`div`,{className:`flex flex-col gap-1`,children:a.map(t=>(0,_.createElement)(h,{...e,key:t.sessionId,agent:t,now:Date.now()}))})},y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`{
  args: {
    agent: workingAgent
  }
