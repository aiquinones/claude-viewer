import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{g as t,n,r,ut as i}from"./iframe-DCjat3KN.js";import{c as a,d as o,f as s,h as c,i as l,l as u,m as d,n as f,u as p}from"./agent-fixtures-DFwE763j.js";import{n as m,t as h}from"./AgentRobotRow-B53eLOrT.js";var g,_,v,y,b,x,S,C,w,T,E,D;function O(){return(O=e((()=>{p(),m(),t(),g=n(),_=i(),v={title:`Agents/AgentRobotRow`,component:h,args:{workspaceRoot:r,onOpen:()=>void 0},decorators:[e=>(0,g.jsx)(`div`,{className:`p-3`,children:(0,g.jsx)(e,{})})],render:e=>(0,g.jsx)(h,{...e,now:Date.now()})},y={args:{agent:c}},b={args:{agent:d}},x={args:{agent:f}},S={args:{agent:u}},C={args:{agent:l}},w={args:{agent:o}},T={args:{agent:s}},E={render:e=>(0,g.jsx)(`div`,{className:`flex flex-col gap-1`,children:a.map(t=>(0,_.createElement)(h,{...e,key:t.sessionId,agent:t,now:Date.now()}))})},y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`{
  args: {
    agent: workingAgent
  }
