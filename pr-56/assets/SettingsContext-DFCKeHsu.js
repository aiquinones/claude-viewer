import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{Q as t,U as n,W as r,Z as i,mt as a,n as o}from"./iframe-BxewVUOQ.js";var s,c,l,u,d,f,p,m,h,g;function _(){return(_=e((()=>{s=a(),t(),r(),c=o(),l=(0,s.createContext)({settings:n,openSettings:()=>void 0,setUsage:()=>void 0,openEstimator:()=>void 0,setEstimator:()=>void 0}),u=({settings:e=n,openSettings:t=()=>void 0,setUsage:r=()=>void 0,openEstimator:i=()=>void 0,setEstimator:a=()=>void 0,children:o})=>(0,c.jsx)(l.Provider,{value:{settings:e,openSettings:t,setUsage:r,openEstimator:i,setEstimator:a},children:o}),d=()=>(0,s.useContext)(l).settings,f=()=>(0,s.useContext)(l).openSettings,p=()=>(0,s.useContext)(l).setUsage,m=()=>(0,s.useContext)(l).openEstimator,h=()=>(0,s.useContext)(l).settings.tokens.estimator.value,g=()=>{let e=h();return(0,s.useCallback)(t=>i({chars:t,estimator:e}),[e])},u.__docgenInfo={description:``,methods:[],displayName:`SettingsProvider`,props:{children:{required:!0,tsType:{name:`ReactNode`},description:``},settings:{defaultValue:{value:`{
  tokens: {
