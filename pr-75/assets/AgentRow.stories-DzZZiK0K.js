import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{g as t,jt as n,n as r,r as i}from"./iframe-DkrsbrJw.js";import{_ as a,a as o,d as s,f as c,h as l,i as u,l as d,n as f,o as p,s as m,u as h,v as g}from"./agent-fixtures-D293OCc9.js";import{n as _,t as v}from"./AgentRow-DbFOnDWo.js";var y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P;function F(){return(F=e((()=>{_(),h(),t(),y=r(),b=n(),x={title:`Agents/AgentRow`,component:v,args:{now:Date.now(),workspaceRoot:i,onOpen:()=>void 0,onOpenLog:()=>void 0,onCopySessionId:()=>void 0,onKill:()=>void 0},decorators:[e=>(0,y.jsx)(`div`,{className:`w-full max-w-2xl p-2`,children:(0,y.jsx)(e,{})})]},S={args:{agent:g}},C={args:{agent:a}},w={args:{agent:d}},T={args:{agent:s}},E={args:{agent:c}},D={args:{agent:l}},O={args:{agent:m}},k={args:{agent:d}},A={args:{agent:p}},j={args:{agent:u}},M={args:{agent:o}},N={render:e=>(0,y.jsx)(`div`,{className:`flex flex-col gap-1`,children:[g,a,f,p].map(t=>(0,b.createElement)(v,{...e,key:t.sessionId,agent:t}))})},S.parameters={...S.parameters,docs:{...S.parameters?.docs,source:{originalSource:`{
  args: {
    agent: workingAgent
  }
